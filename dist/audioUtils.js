...
export class AudioConverter {
     ...
     */
    static pcmFloat32ToWav(pcmData, options = {}) {
     ...
     */
    static async webmToWav(webmBlob, options = {}) {
        const sampleRate = options.sampleRate || 16000;
        const channels = options.channels || 1;
     ...
     */
    static async createTempWavFile(audioBuffer, filename) {
     ...
     */
    static async removeTempFile(filePath) {
        try {
